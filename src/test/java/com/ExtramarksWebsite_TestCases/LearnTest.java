...
// Service Tab Section on post chapter
														try {
															...
															if (learnServiceResult) {
																test.log(LogStatus.PASS, "Learn Service Pass for  "
																		+ subject + ">>" + subSubject + ">>" + chapter);
																System.out.println("Learn Service Pass for  " + subject
																		+ ">>" + subSubject + ">>" + chapter);
															} else {
																test.log(LogStatus.FAIL, "Learn Service Fail for  "
																		+ subject + ">>" + subSubject + ">>" + chapter);
																System.out.println("Learn Service Fail for  " + subject
																		+ ">>" + subSubject + ">>" + chapter);
																sAssert.fail("Learn Service Fail for  " + subject + ">>"
																		+ subSubject + ">>" + chapter);
																actualResult = "Learn_Service_Fail";
															}
														} catch (Exception e) {
															test.log(LogStatus.INFO, "Test Learn Fail for  " + subject
																	+ ">>" + subSubject + ">>" + chapter);
															System.out.println("Test Learn Fail for  " + subject + ">>"
																	+ subSubject + ">>" + chapter);
															sAssert.fail("Test Test Learn for  " + subject + ">>"
																	+ subSubject + ">>" + chapter);
															lp.takeScreenShot();
														}
															...
															if (subSubjectDisplay) {
																...
																if (subSubjsize2 != 0) {
																	...
																	if (clickSubSubjectResult2) {
																		System.out.println(
																				"User navigated on Sub Subjects from Learn Tab "
																						+ subject + ">>" + subSubject);
																...
																System.out.println(
																		"Back Button is not working or timeLimit Exceeds, User not able to navigated on Sub Subjects from Learn Tab  "
																				+ subject + ">>" + subSubject);
																test.log(LogStatus.INFO,
																		"Back Button is not working, User not able to navigated on Sub Subjects from Learn Tab  "
																				+ subject + ">>" + subSubject);
																sAssert.fail(
																		"Back Button is not working, User not able to navigated on Sub Subjects from Learn Tab  "
																				+ subject + ">>" + subSubject);
...
// Service Tab Section on chapter												
											try {
												...
												if (learnServiceResult) {
													test.log(LogStatus.PASS, "Learn Service Pass for  " + subject + ">>"
															+ subSubject + ">>" + chapter);
													System.out.println("Learn Service Pass for  " + subject + ">>"
															+ subSubject + ">>" + chapter);
												} else {
													test.log(LogStatus.FAIL, "Learn Service Fail for  " + subject + ">>"
															+ subSubject + ">>" + chapter);
													System.out.println("Learn Service Fail for  " + subject + ">>"
															+ subSubject + ">>" + chapter);
													sAssert.fail("Learn Service Fail for  " + subject + ">>"
												...
												test.log(LogStatus.INFO, "Test Learn Fail for  " + subject + ">>"
														+ subSubject + ">>" + chapter);
												System.out.println("Test Learn Fail for  " + subject + ">>" + subSubject
														+ ">>" + chapter);
												sAssert.fail("Test Test Learn for  " + subject + ">>" + subSubject
														+ ">>" + chapter);
												lp.takeScreenShot();
											}
											if (chPg.BackToChapter.size() != 0) {
										...
										actualResult = "Learn_Not_able_to_click_on_chapter_Fail " + subject + ">>"
												+ subSubjects + ">>" + chapter;
										System.out.println("Learn_Not_able_to_click_on_Chapter, Location is --> "
												+ subject + ">>" + subSubjects + ">>" + chapter);
										test.log(LogStatus.FAIL, "Learn_Not_able_to_click_on_Chapter, Location is --> "
												+ subject + ">>" + subSubjects + ">>" + chapter);
										sAssert.fail("Learn_Not_able_to_click_on_Chapter, Location is --> " + subject
												+ ">>" + subSubjects + ">>" + chapter);
										Thread.sleep(5000);
									}
								}
...
// if Click on Sub subject Fail								
							...
							actualResult = "Learn_Not_able_to_click_on_Sub_subject_Fail " + subject + ">>"
									+ subSubjects;
							System.out.println("Learn_Not_able_to_click_on_subject, Location is --> " + subject + ">>"
									+ subSubjects);
							test.log(LogStatus.FAIL, "Learn_Not_able_to_click_on_subject, Location is --> " + subject
									+ ">>" + subSubjects);
							sAssert.fail("Learn_Not_able_to_click_on_subject, Location is --> " + subject + ">>"
									+ subSubjects);
							Thread.sleep(5000);
						}
					}
												...
												try {
													...
													if (learnServiceResult) {
														test.log(LogStatus.PASS,
																"Learn Service Pass for  " + subject + ">>" + chapter);
														System.out.println(
																"Learn Service Pass for  " + subject + ">>" + chapter);
													} else {
														test.log(LogStatus.FAIL, "Learn Service Fail for  " + subject
														...
														System.out.println("Learn Service Fail for  " + subject + ">>"
																+ subject + ">>" + chapter);
														sAssert.fail(
																"Learn Service Fail for  " + subject + ">>" + chapter);
														actualResult = "Learn_Service_Fail";
													}
												} catch (Exception e) {
													test.log(LogStatus.INFO,
															"Test Learn Fail for  " + subject + ">>" + chapter);
													System.out.println(
															"Test Learn Fail for  " + subject + ">>" + chapter);
													sAssert.fail("Test Test Learn for  " + subject + ">>" + chapter);
													lp.takeScreenShot();
												}
												if (chPg.BackToChapter.size() != 0) {
													JavascriptExecutor jslpt = (JavascriptExecutor) driver;
													...
													if (subSubjectDisplay) {
														...
														if (subjsize2 != 0) {
															...
															if (clickSubSubjectResult2) {
																System.out.println(
																		"User navigated on Subjects from Learn Tab "
																				+ subject);
...
// Service Tab Section on sub chapter												
											try {
												...
												if (learnServiceResult) {
													...
													System.out.println("Learn Service Fail for  " + subject + ">>"
															+ subject + ">>" + chapter);
													sAssert.fail("Learn Service Fail for  " + subject + ">>" + chapter);
													actualResult = "Learn_Service_Fail";
												}
											} catch (Exception e) {
												test.log(LogStatus.INFO,
														"Test Learn Fail for  " + subject + ">>" + chapter);
												System.out.println("Test Learn Fail for  " + subject + ">>" + chapter);
												sAssert.fail("Test Test Learn for  " + subject + ">>" + chapter);
												lp.takeScreenShot();
											}
											if (chPg.BackToChapter.size() != 0) {
...
// Service Tab Section on chapter										
									try {
										...
										if (learnServiceResult) {
											test.log(LogStatus.PASS,
													"Learn Service Pass for  " + subject + ">>" + chapter);
											System.out.println("Learn Service Pass for  " + subject + ">>" + chapter);
										} else {
											test.log(LogStatus.FAIL, "Learn Service Fail for  " + subject + ">>"
													+ subject + ">>" + chapter);
											System.out.println("Learn Service Fail for  " + subject + ">>" + subject
													+ ">>" + chapter);
											sAssert.fail("Learn Service Fail for  " + subject + ">>" + chapter);
											actualResult = "Learn_Service_Fail";
										}
									} catch (Exception e) {
										test.log(LogStatus.INFO, "Test Learn Fail for  " + subject + ">>" + chapter);
										System.out.println("Test Learn Fail for  " + subject + ">>" + chapter);
										sAssert.fail("Test Test Learn for  " + subject + ">>" + chapter);
										lp.takeScreenShot();
									}
									if (chPg.BackToChapter.size() != 0) {
										...
										if (subSubjectDisplay) {
											...
											if (subjsize2 != 0) {
												...
												if (clickSubSubjectResult2) {
													System.out.println(
															"User navigated on Subjects from Learn Tab " + subject);
...
// if Click on chapter Fail	
								...
								actualResult = "Learn_Not_able_to_click_on_chapter_Fail " + subject + ">>" + chapter;
								System.out.println("Learn_Not_able_to_click_on_Chapter, Location is --> " + subject
										+ ">>" + chapter);
								test.log(LogStatus.FAIL, "Learn_Not_able_to_click_on_Chapter, Location is --> "
										+ subject + ">>" + chapter);
								sAssert.fail("Learn_Not_able_to_click_on_Chapter, Location is --> " + subject + ">>"
						...
						actualResult = "Learn_Chapter page is not Displayed_FAIL";
						System.out.println("Chapter page is not Displayed, Location is --> " + subject);
						test.log(LogStatus.FAIL, "Chapter page is not Displayed, Location is --> " + subject);
						sAssert.fail("Chapter page is not Displayed, Location is --> " + subject);
						Thread.sleep(5000);
...
// if Click on Subject Fail			
				...
				actualResult = "Learn_Not_able_to_click_on_subject_Fail " + subject;
				System.out.println("Learn_Not_able_to_click_on_subject, Location is --> " + subject);
				test.log(LogStatus.FAIL, "Learn_Not_able_to_click_on_subject, Location is --> " + subject);
				sAssert.fail("Learn_Not_able_to_click_on_subject --> " + subject);
				Thread.sleep(5000);
			}
