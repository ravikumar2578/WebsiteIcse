...
// Service Tab Section on post chapter
														try {
															...
															if (practiceServiceResult) {
																test.log(LogStatus.PASS, "Practice Service Pass for  "
																		+ subject + ">>" + subSubject + ">>" + chapter);
																System.out.println("Practice Service Pass for  " + subject
																		+ ">>" + subSubject + ">>" + chapter);
															} else {
																test.log(LogStatus.FAIL, "Practice Service Fail for  "
																		+ subject + ">>" + subSubject + ">>" + chapter);
																System.out.println("Practice Service Fail for  " + subject
																		+ ">>" + subSubject + ">>" + chapter);
																sAssert.fail("Practice Service Fail for  " + subject + ">>"
																		+ subSubject + ">>" + chapter);
																actualResult = "Practice_Service_Fail";
															}
														} catch (Exception e) {
															test.log(LogStatus.INFO, "Test Practice Fail for  " + subject
																	+ ">>" + subSubject + ">>" + chapter);
															System.out.println("Test Practice Fail for  " + subject + ">>"
																	+ subSubject + ">>" + chapter);
															sAssert.fail("Test Practice Practice for  " + subject + ">>"
																	+ subSubject + ">>" + chapter);
															lp.takeScreenShot();
														}
															...
															if (subSubjectDisplay) {
																...
																if (subSubjsize2 != 0) {
																	...
																	if (clickSubSubjectResult2) {
																		System.out.println(
																				"User navigated on Sub Subjects from Practice Tab "
																						+ subject + ">>" + subSubject);
																...
																System.out.println(
																		"Back Button is not working or timeLimit Exceeds, User not able to navigated on Sub Subjects from Practice Tab  "
																				+ subject + ">>" + subSubject);
																test.log(LogStatus.INFO,
																		"Back Button is not working, User not able to navigated on Sub Subjects from Practice Tab  "
																				+ subject + ">>" + subSubject);
																sAssert.fail(
																		"Back Button is not working, User not able to navigated on Sub Subjects from Practice Tab  "
																				+ subject + ">>" + subSubject);
...
// Service Tab Section on chapter												
										...
										actualResult = "Practice_Not_able_to_click_on_chapter_Fail " + subject + ">>"
												+ subSubjects + ">>" + chapter;
										System.out.println("Practice_Not_able_to_click_on_Chapter, Location is --> "
												+ subject + ">>" + subSubjects + ">>" + chapter);
										test.log(LogStatus.FAIL, "Practice_Not_able_to_click_on_Chapter, Location is --> "
												+ subject + ">>" + subSubjects + ">>" + chapter);
										sAssert.fail("Practice_Not_able_to_click_on_Chapter, Location is --> " + subject
												+ ">>" + subSubjects + ">>" + chapter);
										Thread.sleep(5000);
									}
								}
...
// if Click on Sub subject Fail								
							...
							actualResult = "Practice_Not_able_to_click_on_Sub_subject_Fail " + subject + ">>"
									+ subSubjects;
							System.out.println("Practice_Not_able_to_click_on_subject, Location is --> " + subject + ">>"
									+ subSubjects);
							test.log(LogStatus.FAIL, "Practice_Not_able_to_click_on_subject, Location is --> " + subject
									+ ">>" + subSubjects);
							sAssert.fail("Practice_Not_able_to_click_on_subject, Location is --> " + subject + ">>"
									+ subSubjects);
							Thread.sleep(5000);
						}
					}
												...
												try {
													...
													if (practiceServiceResult) {
														test.log(LogStatus.PASS,
																"Practice Service Pass for  " + subject + ">>" + chapter);
														System.out.println(
																"Practice Service Pass for  " + subject + ">>" + chapter);
													} else {
														test.log(LogStatus.FAIL, "Practice Service Fail for  " + subject
																+ ">>" + subject + ">>" + chapter);
														System.out.println("Practice Service Fail for  " + subject + ">>"
																+ subject + ">>" + chapter);
														sAssert.fail(
																"Practice Service Fail for  " + subject + ">>" + chapter);
														actualResult = "Practice_Service_Fail";
													}
												} catch (Exception e) {
													test.log(LogStatus.INFO,
															"Test Practice Fail for  " + subject + ">>" + chapter);
													System.out.println(
															"Test Practice Fail for  " + subject + ">>" + chapter);
													sAssert.fail("Test Practice Practice for  " + subject + ">>" + chapter);
													lp.takeScreenShot();
												}
												if (chPg.BackToChapter.size() != 0) {
													JavascriptExecutor jslpt = (JavascriptExecutor) driver;
													...
													if (subSubjectDisplay) {
														...
														if (subjsize2 != 0) {
															...
															if (clickSubSubjectResult2) {
																System.out.println(
																		"User navigated on Subjects from Practice Tab "
																				+ subject);
...
// if Click on chapter Fail	
								...
								actualResult = "Practice_Not_able_to_click_on_chapter_Fail " + subject + ">>" + chapter;
								System.out.println("Practice_Not_able_to_click_on_Chapter, Location is --> " + subject
										+ ">>" + chapter);
								test.log(LogStatus.FAIL, "Practice_Not_able_to_click_on_Chapter, Location is --> "
										+ subject + ">>" + chapter);
								sAssert.fail("Practice_Not_able_to_click_on_Chapter, Location is --> " + subject + ">>"
						...
						actualResult = "Practice_Chapter page is not Displayed_FAIL";
						System.out.println("Chapter page is not Displayed, Location is --> " + subject);
						test.log(LogStatus.FAIL, "Chapter page is not Displayed, Location is --> " + subject);
						sAssert.fail("Chapter page is not Displayed, Location is --> " + subject);
						Thread.sleep(5000);
...
// if Click on Subject Fail			
				...
				actualResult = "Practice_Not_able_to_click_on_subject_Fail " + subject;
				System.out.println("Practice_Not_able_to_click_on_subject, Location is --> " + subject);
				test.log(LogStatus.FAIL, "Practice_Not_able_to_click_on_subject, Location is --> " + subject);
				sAssert.fail("Practice_Not_able_to_click_on_subject --> " + subject);
				Thread.sleep(5000);
			}
